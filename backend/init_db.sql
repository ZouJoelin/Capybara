...
-- ALTER TABLE print_order ADD COLUMN spend_coins INTEGER NOT NULL DEFAULT 0;
...
-- INSERT INTO print_order SELECT user_id, filename, pages, paper_type, color, sides, copies, spend_coins, fee, out_trade_no, device, trade_type, trade_state, trade_time, print_state FROM print_order_bkp;
...
CREATE TABLE share (user_open_id TEXT NOT NULL, share_date TEXT NOT NULL, share_times INTEGER NOT NULL DEFAULT 1);
